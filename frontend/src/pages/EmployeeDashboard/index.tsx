  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Main Content (Show only after customer selected) */}
        {customer && (
          <>
            {/* Add Segments */}
            <SegmentForm
            ...
            <SegmentTable
              ...
              onFreezeSegment={() => {}}
              onReopenSegment={() => {}}
              onAddNote={handleAddCorrectionNote}
            ...
            <BillActionsPanel
              ...
              onReopenSelected={handleReopenSelected}
              onAddCorrectionNote={handleAddCorrectionNote}
              onUndoCorrectionNote={handleUndoNote}
      ...
      <ConfirmModal
        ...
        message={
          confirmModal.action === 'submit'
            ? 'Are you sure you want to submit this bill for admin review?'
            : confirmModal.action === 'freeze'
            ? `Complete ${selectedSegments.size} segment(s)?`
            : confirmModal.action === 'delete'
            ? `Delete ${selectedSegments.size} segment(s)? This cannot be undone.`
            : `Reopen ${selectedSegments.size} segment(s)?`
        }
        ...
        onCancel={() => setConfirmModal({ isOpen: false, action: '', segmentId: '' })}
        isLoading={isLoading}
      />
      ...
      <InputModal
        ...
        onValueChange={(value) => setInputModal(prev => ({ ...prev, value }))}
        onConfirm={executeSaveNote}
        onCancel={() => setInputModal({ isOpen: false, segmentId: '', value: '' })}
        isLoading={isLoading}
      />
      ...
      <SuccessMessage
        ...
        onClose={() => setSuccessMessage({ isOpen: false, text: '' })}
      />

      <ErrorMessage
        isOpen={errorMessage.isOpen}
        message={errorMessage.text}
        onClose={() => setErrorMessage({ isOpen: false, text: '' })}
      />
    </div>
  );
};
